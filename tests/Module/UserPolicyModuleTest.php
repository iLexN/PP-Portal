...
class UserPolicyModuleTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testgetPolicyList()
    {
        ...
        $this->assertArrayHasKey('plan_id', $policyList[0]);
        ...
        $this->assertArrayHasKey('plan', $policyList[0]);
        $this->assertArrayHasKey('plan', $policyList[0]);
        $this->assertArrayHasKey('policyfile', $policyList[0]);
        $this->assertArrayHasKey('policyuser', $policyList[0]);
    }
}
